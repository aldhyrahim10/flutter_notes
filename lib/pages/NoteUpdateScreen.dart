...
class _NoteUpdateScreenState extends State<NoteUpdateScreen>{
  ...
  void initState(){
    ...
    if (widget.note.image != null && widget.note.image!.isNotEmpty) {
      _selectedImage = File(widget.note.image!);
    }

    // Listener untuk update tombol simpan
